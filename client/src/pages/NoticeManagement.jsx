...
import { AdminLayout, Button, Card, HodLayout, LoadingSpinner, Modal, TeacherLayout } from '../components';
...
const NoticeManagement = () => {
  ...
  if (loading) {
    return (
      <Layout title="Notice Management" userName={storedUser?.name || 'User'} onLogout={handleLogout}>
        <LoadingSpinner />
      </Layout>
    );
  }
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {role === 'hod' && <option value="Branch">Branch</option>}
                    </select>
                  </div>
                </div>
