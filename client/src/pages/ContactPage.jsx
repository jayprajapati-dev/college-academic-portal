  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-[#111318] dark:text-white min-h-screen flex flex-col mesh-background">
      ...
      <main className="flex-1 pt-12 sm:pt-14">
        <div className="max-w-[1200px] mx-auto w-full px-4 py-5 sm:py-8">
          <div className="mb-6 sm:mb-10">
            <h2 className="text-xl sm:text-2xl font-black leading-tight tracking-[-0.033em] mb-2">Get in Touch with Our Academic Team</h2>
            <p className="text-[#636c88] dark:text-gray-400 text-sm max-w-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10">
            <div className="lg:col-span-5 flex flex-col gap-6">
              <div>
                <h3 className="text-base sm:text-lg font-bold mb-4">Official Contact Information</h3>
              ...
              <div className="bg-primary/5 dark:bg-primary/10 border-l-4 border-primary p-4 rounded-r-xl">
            ...
            <div className="lg:col-span-7">
              <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/50 dark:shadow-none">
                <h3 className="text-lg sm:text-xl font-bold mb-4">Send a Message</h3>

                {!isLoggedIn && (
                  <div className="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                    <p className="text-sm font-semibold text-yellow-800 dark:text-yellow-200">
                      You must be logged in to submit a message. <a href="/login" className="underline hover:text-primary">Login here</a>
                    </p>
                  </div>
                )}
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex flex-col gap-2">
                      ...
                      <input
                        className="w-full px-3 py-2.5 text-sm rounded-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-900 bg-gray-100 cursor-not-allowed"
                        id="full-name"
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <select
                      className="w-full px-3 py-2.5 text-sm rounded-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-900 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                      id="subject"
                      name="subject"
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      className="w-full px-3 py-2.5 text-sm rounded-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-900 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all resize-none"
                      id="message"
                      name="message"
                  ...
                  <button
                    className={`w-full font-bold py-3 text-sm rounded-xl transition-all flex items-center justify-center gap-2 ${
                      isLoggedIn && !loading
              ...
              {isLoggedIn && myMessages.length > 0 && (
                <div className="mt-5 bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-100 dark:border-gray-700 shadow-xl">
                  <h3 className="text-lg sm:text-xl font-bold mb-4">My Messages</h3>
                  <div className="space-y-4">
                    {myMessages.map((msg, index) => (
                      <div key={msg._id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-3">
                            <span className="text-base sm:text-xl font-bold text-primary">#{index + 1}</span>
                            <div>
                              <h4 className="font-bold text-sm sm:text-base">{msg.subject}</h4>
      ...
      <div className="max-w-[1200px] mx-auto px-4 lg:px-10 py-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 rounded-2xl my-6">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-5 text-center">
          Quick FAQ
        </h2>
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
          <div className="bg-white dark:bg-slate-700 rounded-xl p-4 shadow">
        ...
        <div className="text-center mt-8">
          <a
            href="/faq"
            className="px-5 py-2 bg-blue-600 text-white text-sm font-bold rounded-lg hover:bg-blue-700 transition-all inline-block"
          >
            View All FAQs
          </a>
        </div>
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-[#dcdee5] dark:border-[#2d3244] py-6">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 text-xs sm:text-sm text-[#636c88] dark:text-slate-400 font-medium">
