...
import { HodLayout, Button, Modal, Input, Card, LoadingSpinner } from '../../components';
import axios from 'axios';

const HodTaskManagement = () => {
  ...
  const fetchTasks = useCallback(async () => {
    try {
      ...
      const res = await axios.get('/api/tasks/hod', {
  ...
  // Fetch subjects and semesters for HOD's branch
  ...
  if (loading) {
    return (
      <HodLayout title="Task Management" onLogout={handleLogout}>
        <LoadingSpinner />
      </HodLayout>
    );
  }
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1 font-medium">
              Manage subject tasks for your branch
            </p>
          </div>
          <Button
...
export default HodTaskManagement;
