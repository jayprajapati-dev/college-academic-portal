...
const AboutPage = () => {
  ...
  <div className="bg-background-light dark:bg-background-dark text-[#111318] dark:text-white antialiased min-h-screen flex flex-col mesh-background">
    <Header />
    <main className="pt-12 sm:pt-14 flex-1">
      <section className="max-w-[1200px] mx-auto px-4 lg:px-10 py-8 md:py-16">
        <div className="grid md:grid-cols-2 gap-6 items-center">
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold leading-[1.1] tracking-tight">
              Empowering <span className="text-primary">Academic</span> Excellence
            </h1>
            <p className="text-sm sm:text-base text-[#636c88] dark:text-slate-400 leading-relaxed max-w-lg">
            ...
            <div className="flex gap-3 flex-wrap">
              <a className="bg-primary text-white px-4 sm:px-6 py-2 sm:py-3 text-sm rounded-lg font-bold hover:scale-[1.02] transition-transform" href="/">
                Explore Resources
              </a>
              <a className="border border-[#dcdee5] dark:border-[#2d3244] px-4 sm:px-6 py-2 sm:py-3 text-sm rounded-lg font-bold hover:bg-white/50 transition-colors" href="/contact">
                Our Team
              </a>
            </div>
          </div>
      ...
      <section className="bg-white dark:bg-slate-900 border-y border-[#dcdee5] dark:border-[#2d3244]">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-10 py-6 sm:py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <div className="text-center md:text-left">
              <p className="text-xl sm:text-2xl font-extrabold text-primary mb-1">10k+</p>
              <p className="text-sm font-medium text-[#636c88] dark:text-slate-400 uppercase tracking-wider">Students Reached</p>
            </div>
            <div className="text-center md:text-left">
              <p className="text-xl sm:text-2xl font-extrabold text-primary mb-1">500+</p>
              <p className="text-sm font-medium text-[#636c88] dark:text-slate-400 uppercase tracking-wider">Resources Available</p>
            </div>
            <div className="text-center md:text-left">
              <p className="text-xl sm:text-2xl font-extrabold text-primary mb-1">100+</p>
              <p className="text-sm font-medium text-[#636c88] dark:text-slate-400 uppercase tracking-wider">Expert Mentors</p>
            </div>
            <div className="text-center md:text-left">
              <p className="text-xl sm:text-2xl font-extrabold text-primary mb-1">50+</p>
              <p className="text-sm font-medium text-[#636c88] dark:text-slate-400 uppercase tracking-wider">Academic Partners</p>
            </div>
          </div>
        </div>
      </section>
      <section className="max-w-[1200px] mx-auto px-4 lg:px-10 py-8 sm:py-14">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold tracking-tight mb-3">Our Core Philosophy</h2>
          <div className="w-16 h-1 bg-primary mx-auto rounded-full"></div>
        </div>
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
          <div className="flex flex-col gap-3 sm:gap-4 rounded-xl border border-[#dcdee5] dark:border-[#2d3244] bg-white dark:bg-slate-900 p-5 sm:p-7 hover:shadow-xl transition-shadow group">
            ...
            <h3 className="text-base sm:text-xl font-bold">Our Vision</h3>
            <p className="text-[#636c88] dark:text-slate-400 leading-relaxed text-sm sm:text-base">
          ...
          <div className="flex flex-col gap-3 sm:gap-4 rounded-xl border border-[#dcdee5] dark:border-[#2d3244] bg-white dark:bg-slate-900 p-5 sm:p-7 hover:shadow-xl transition-shadow group">
            ...
            <h3 className="text-base sm:text-xl font-bold">Our Mission</h3>
            <p className="text-[#636c88] dark:text-slate-400 leading-relaxed text-sm sm:text-base">
      ...
      <section className="bg-background-light dark:bg-[#0d101b] py-8 sm:py-14">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-6 sm:mb-10 gap-4">
            <div className="max-w-xl">
              <h2 className="text-xl sm:text-2xl font-bold tracking-tight mb-2">What We Provide</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-xl border border-[#dcdee5] dark:border-[#2d3244] flex flex-col gap-3">
              <span className="material-symbols-outlined text-primary text-2xl">menu_book</span>
              <h4 className="text-base font-bold">Subject Details</h4>
            ...
            <div className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-xl border border-[#dcdee5] dark:border-[#2d3244] flex flex-col gap-3">
              ...
              <h4 className="text-base font-bold">Materials</h4>
            ...
            <div className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-xl border border-[#dcdee5] dark:border-[#2d3244] flex flex-col gap-3">
              ...
              <h4 className="text-base font-bold">Notices</h4>
